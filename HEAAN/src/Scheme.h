...
public:
	...
	Scheme(SecretKey& secretKey, Ring& ring, bool isSerialized = false, string root_path="./");
	Scheme(Ring& ring, bool isSerialized = false, string root_path="./");
